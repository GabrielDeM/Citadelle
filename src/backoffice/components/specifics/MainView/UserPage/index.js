...
import { emit as emitCitadel, on as onCitadel } from '../../../../socket/citadel';
            ...
            <div className="new-index">
              <div className="userPage">
                <div className="left-content">
                  <Avatar src={user.avatar && user.avatar} alt="avatar" className="user-avatar">
                ...
                <div className="right-content">
                  <ul className="userpage-ul">
                    ...
                    <li className="userpage-li">
                      <span className="userpage-span">Statut:</span> {user.online ? "Connecté" : "Non connecté"}
                    </li>
                  </ul>
                </div>
              </div>
